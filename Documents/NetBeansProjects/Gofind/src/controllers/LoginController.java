        ...
        if (event.getSource() == btnSignin) {
            ...
            if (logIn().equals("Success")) {
                try {
                    ...
                    stage.close();
                    Scene scene = new Scene(FXMLLoader.load(getClass().getResource("/fxml/OnBoardUser.fxml")));
    ...
    private String logIn() {
        ...
        if(email.isEmpty() || password.isEmpty()) {
            ...
            try {
                ...
                if (!resultSet.next()) {
                    setLblError(Color.TOMATO, "Mot de passe ou nom Utilisateur incorrect");
                    status = "Error";
                } else {
